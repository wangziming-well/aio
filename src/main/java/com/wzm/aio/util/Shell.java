...
public class Shell {
    ...
    public static void test1() {
        URL resource = Shell.class.getClassLoader().getResource("temp.cmd");
        String file = resource.getFile();
        file = new String(file.getBytes(), 1, file.length() - 1);
        List<MatchEntry> build = Shell.matchesBuilder()
                .add("名字", "123456")
                .add("年龄", "44")
                .add("请按任意键继续.", "\r")
                .build();
        ...
        String s = execStr(build, "E:\\Temp", file);
